...
# 2. Quantas vezes o trecho de pseudocódigo seguinte imprime 'oi'? (obs: na
...
# 3. Entre 1067 e 3627 (inclusive), quantos números são pares e também
# divisíveis por 7?
# Answer: 183
cont = 0
...
# 4. Daniela é uma pessoa muito supersticiosa. Para ela, um número é sortudo
...
# 5. Na pacata vila campestre de Ponteironuloville, todos os telefones têm 6
...
phone = '''213752 216732 221063 221545 225583 229133 230648 233222
...
cont = 0
for f in phone:
    if not same(f) and evenplus(f) and f[0]!=f[-1]:
        cont += 1
print (cont)
        
print (len([f for f in phone if not same(f) and evenplus(f) and f[0]!=f[-1]]))
